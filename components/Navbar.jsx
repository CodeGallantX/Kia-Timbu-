...
const Navbar = () => {
    return (
      <div style={inLineinLineStyles.navbarContainer}>
        <div style={inLineinLineStyles.navbarContent}>
          <div style={inLineinLineStyles.logoAndSearch}>
            <img
              src="https://ik.imagekit.io/mshcgnjju/CHEF%20-%20Timbu%20Cloud%20Store/logo.png" 
              alt="Logo"
              style = {{
              width: '104px',
              height:'24'
        ...
        <div style={inLineinLineStyles.navLinksContainer}>
          ...
          <NavLink href="#">Kitchen appliances</NavLink>
